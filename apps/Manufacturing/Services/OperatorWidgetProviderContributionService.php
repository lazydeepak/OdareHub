...
final class OperatorWidgetProviderContributionService
{
    ...
    public static function providerCatalog(): array
    {
        return [
            ...
            ['provider_name' => 'BOM / Recipes', 'module_key' => 'Bom', 'provider_key' => 'bom', 'class' => 'Apps\\Manufacturing\\Modules\\Bom\\Services\\BomWidgetRegistry', 'file' => APP_ROOT . '/apps/Manufacturing/modules/Bom/Services/BomWidgetRegistry.php'],
