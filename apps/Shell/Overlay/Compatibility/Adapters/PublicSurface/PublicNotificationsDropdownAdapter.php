...
final class PublicNotificationsDropdownAdapter
{
...
(function () {
  ...
  window.SusankhyaOS.ShellOverlayAdapters.createPublicNotificationsDropdownAdapter = function (options) {
    var config = options && typeof options === 'object' ? options : {};
    var overlayType = 'public_notifications_dropdown';
    var instance = null;
    ...
    function open(reason) {
      ...
      if (fw && fw.manager && typeof fw.manager.open === 'function') {
        instance = fw.manager.open({
          ...
          reason: reason || 'open',
          triggerSelector: config.triggerSelector || '[data-notif-toggle]',
          surfaceId: config.surfaceId || 'topbarNotifDropdown',
          owner: 'Shell',
          isModal: false,
          preset: 'dropdown',
