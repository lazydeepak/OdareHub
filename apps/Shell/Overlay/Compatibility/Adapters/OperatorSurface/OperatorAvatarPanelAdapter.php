...
final class OperatorAvatarPanelAdapter
{
    ...
    function open(reason) {
      ...
      if (fw && fw.manager && typeof fw.manager.open === 'function') {
        instance = fw.manager.open({
          ...
          reason: reason || 'open',
          triggerId: config.triggerId || 'headerAvatarButton',
          surfaceId: config.surfaceId || 'headerAvatarPanel',
          backdropId: config.backdropId || 'avatarBackdrop',
          owner: 'Shell',
          isModal: true,
          preset: 'drawer',
