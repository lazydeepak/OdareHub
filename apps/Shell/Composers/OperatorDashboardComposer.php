...
final class OperatorDashboardComposer
{
    ...
    private function render(array $data, array $i18n): string
    {
        ...
        $isHospitalityFocus = ($focus === 'hospitality');
        ...
        ?>
            <div class="app-stack">
                ...
                <?php if ($isHospitalityFocus): $__focusView = $resolveFocusView('hospitality', APP_ROOT . '/apps/Shell/Views/operator/dashboard.php'); include $__focusView; endif; ?>
