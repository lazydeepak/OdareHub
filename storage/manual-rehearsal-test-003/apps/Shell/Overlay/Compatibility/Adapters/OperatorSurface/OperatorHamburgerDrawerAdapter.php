...
final class OperatorHamburgerDrawerAdapter
{
    ...
    function open(reason) {
      ...
      if (fw && fw.manager && typeof fw.manager.open === 'function') {
        instance = fw.manager.open({
          ...
          reason: reason || 'open',
          triggerId: config.triggerId || 'hamburgerToggle',
          surfaceId: config.surfaceId || 'hamburgerMenu',
          backdropId: config.backdropId || 'hamburgerBackdrop',
          owner: 'Shell',
          isModal: true,
          preset: 'drawer',
