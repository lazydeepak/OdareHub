...
namespace Plugins\DailyOrders\Controllers;

use App\Core\Auth;
use App\Core\DB;
use App\Core\EntityContext;
use App\Core\View;
use Plugins\DailyOrders\Services\Order360Service;
...
require_once __DIR__ . '/../DailyOrderService.php';
...
final class DailyOrdersController
{
    ...
    public static function index(View $view): void
    {
        ...
        $view->render('DailyOrders::index.php', [
    ...
    {
        $view->render('DailyOrders::add.php', [
    ...
    {
        $view->render('DailyOrders::import.php', [
    ...
    public static function create(array $input): void
    {
        ...
        try {
            ...
            DailyOrderService::create($insertData, $context);
    ...
    public static function editForm(View $view, int $id): void
    {
        ...
        $view->render('DailyOrders::edit.php', [
    ...
    public static function order360(View $view, int $id): void
    {
        ...
        $view->render('DailyOrders::order_360.php', [
    ...
    public static function update(array $input): void
    {
        ...
        $existing = DB::fetchOne('SELECT product_id FROM daily_orders WHERE id=? LIMIT 1', [$id]);
        if (!$existing) {
            self::flash('err', 'Daily order not found.');
            header('Location: /daily-orders');
            exit;
        ...
        try {
            ...
            DailyOrderService::update($id, $updateData, $context, $existing);
            ...
            header('Location: /daily-orders/edit?id=' . $id);
            exit;
        }
    }
    ...
    public static function delete(int $id): void
    {
        ...
        try {
            $context = EntityContext::fromUser(Auth::user());
            DailyOrderService::delete($id, $context);
