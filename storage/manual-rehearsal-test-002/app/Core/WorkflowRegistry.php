...
if (!class_exists(__NAMESPACE__ . '\\WorkflowRegistry', false) && class_exists(\Plugins\Workflow\Services\WorkflowRegistry::class)) {
    class_alias(\Plugins\Workflow\Services\WorkflowRegistry::class, __NAMESPACE__ . '\\WorkflowRegistry');
}
