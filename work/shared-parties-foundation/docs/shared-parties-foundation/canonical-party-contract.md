...
- `apps/SBAIO/modules/Customers/install.php` (table `sbaio_customers`)
...
- `sbaio_customers`: `id`, `customer_name`, `contact_name`, `email`, `phone`, `status`, audit — local customer identity.
