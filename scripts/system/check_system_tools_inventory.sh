...
check_text "docs/architecture/SUSANKHYA-OS-ARCHITECTURE-CHARTER-V1.md" "System Tools maintain/validate/repair but do not bypass governance." "charter documents System Tools no-bypass law"
