...
Branch: work/shared-items-foundation (from 316b806; remote-safe after push; no merge to main)
Reference: session-d-shared-app-suite-extension-contract @ c886b89 (governance/reference; not rewritten)
Status: AUDIT + CONTRACT + MINIMAL PROPOSAL — no Manufacturing migration; no suite extension; no DB mutation.
